...
class QVulkanExtension(PyQt6.sip.simplewrapper):
    ...
    name = ... # type: QtCore.QByteArray|bytes|bytearray|memoryview
    version = ... # type: int
...
class QVulkanLayer(PyQt6.sip.simplewrapper):
    ...
    description = ... # type: QtCore.QByteArray|bytes|bytearray|memoryview
    name = ... # type: QtCore.QByteArray|bytes|bytearray|memoryview
...
class QVulkanInstance(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def surfaceForWindow(window: QWindow|None) -> PyQt6.sip.voidptr: ...
    def isValid(self) -> bool: ...
    def destroy(self) -> None: ...
    def create(self) -> bool: ...
